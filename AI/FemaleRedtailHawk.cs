...
/// 红尾鹰（雌）- 使用Grid系统
/// </summary>
public class FemaleRedtailHawk : MonsterBase
{
    [Header("攻击设置 - 爪击")]
    public int clawHitBonus = 4;
    public int clawDiceCount = 2;
    public int clawDiceSides = 3;
    public int clawDamageBonus = 2;

    [Header("攻击设置 - 啄击")]
    public int peckHitBonus = 3;
    public int peckDiceCount = 1;
    public int peckDiceSides = 6;
    public int peckDamageBonus = 2;
